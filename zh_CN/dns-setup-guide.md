...
## 索引
- [自定义设置 DNS 服务器](#自定义设置-dns-服务器)
  - [索引](#索引)
  - [常用第公共 DNS 提供商](#常用第公共-dns-提供商)
    - [国内](#国内)
    - [国外](#国外)
  - [Windows 7/8/10](#windows-7810)
...
## macOS
1. 选取苹果菜单 >“系统偏好设置”    
![打开系统偏好设置](/images/dns/dns-mac01.png)

2. 找到网络图标，点击进入  
![系统偏好设置](/images/dns/dns-mac02.png)

3. 从列表中选择想要使用的网络连接服务（例如 WIFI 或以太网），然后点按“高级”  
![选择连接](/images/dns/dns-mac03.png)

4. 找到DNS的标签，然后点击左下角“+”，填写希望使用的 DNS 服务器，之后点击"好"  
![设置 DNS](/images/dns/dns-mac04.png)

5. 返回到上一级，确认设置，并点击“应用”  
![确认与应用](/images/dns/dns-mac05.png)
